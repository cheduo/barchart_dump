...
csv_files = [file for file in os.listdir(downloads_path) if 
             file.endswith('.csv') and
             file.startswith('vij25_intraday-nearby-1min_historical-data-download-04-07-2025')
             ]
...
# combined_data.head()
combined_data.to_csv(r"C:\Users\cdsjt\data\UX_data.csv", index=False)